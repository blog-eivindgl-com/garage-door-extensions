...
## ESP32 WROOM 32D board is visualized as four 8-pin headers in the sketch.
 ...
 - D25 is the yellow wire going through a 10kΩ resistor to a [VO617A Optocoupler](https://mou.sr/45uYfCM). The other side of the optocoupler is connected to the +27V signal to the Open Door switch of the original Windsor control unit.
